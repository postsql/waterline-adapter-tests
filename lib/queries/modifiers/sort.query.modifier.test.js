...
describe('Query', function() {
  ...
  describe('Multiple SORT criteria searches', function() {
    ...
    it('should sort records using multiple sort criteria from object, with first name desc', function(done) {
    ...
    it('should sort records using multiple sort criteria from object, with first name asc', function(done) {
    ...
    it('should sort records using multiple sort criteria from list, with first name desc', function(done) {
      User.find({ where: { type: 'sort test multi' }, sort: [{ last_name: 1}, {first_name: 0 }]}, function(err, users) {
        assert(!err);
    ...
    it('should sort records using multiple sort criteria from list, with first name asc', function(done) {
      User.find({ where: { type: 'sort test multi' }, sort: [{ last_name: 1}, {first_name: 1 }] }, function(err, users) {
        assert(!err);
